...
Общие стандарты по написаню кода, именованию файлов и прочему позволяют легче разбираться с существующими проектами даже новичкам.
...
Внутри строк (_alighnment_, выравнивание) — пробелами.
